            ...
            <div>
              ...
              <div className="flex items-center gap-6 mb-6">
                ...
                <div className="flex items-center text-gray-600">
                  ...
                  <span>Email: dr.swarali@sculptderma.com</span>
                </div>
              </div>
              ...
              <div className="aspect-square bg-gradient-to-br from-primary-100 to-accent-100 rounded-3xl overflow-hidden shadow-xl">
                <div className="w-full h-full flex items-center justify-center">
                  <div className="text-center p-12">
                    ...
                    <p className="text-gray-600 font-medium">Dr. Swarali</p>
                    <p className="text-primary-600 text-sm">Cosmetology & Trichology</p>
                  </div>
                </div>
              </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="bg-gray-50 rounded-xl p-6">
                    <h4 className="font-semibold text-gray-900 mb-2">M.D. from University of Zurich, Switzerland</h4>
                    <p className="text-gray-600">Advanced medical degree with specialization in aesthetic medicine</p>
                  </div>
                  <div className="bg-gray-50 rounded-xl p-6">
                    <h4 className="font-semibold text-gray-900 mb-2">Board certification</h4>
                    <p className="text-gray-600">International Society of Aesthetic Plastic Surgery (ISAPS)</p>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="bg-gray-50 rounded-xl p-6">
                    <h4 className="font-semibold text-gray-900 mb-2">Laser Skin Resurfacing & Pigmentation Correction</h4>
                    <p className="text-gray-600">Advanced laser treatments for skin rejuvenation and pigmentation issues</p>
                  </div>
                  <div className="bg-gray-50 rounded-xl p-6">
                    <h4 className="font-semibold text-gray-900 mb-2">Years of Practice</h4>
                    <p className="text-gray-600">7 years of experience in cosmetology and trichology</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                { day: "Tuesday", time: "14:00-19:00", available: true },
                { day: "Wednesday", time: "-", available: false },
                { day: "Thursday", time: "14:00-19:00", available: true },
                { day: "Friday", time: "14:00-19:00", available: true },
                { day: "Saturday", time: "14:00-19:00", available: true }
              ].map((schedule, index) => (
      ...
      <section className="section-padding bg-gradient-to-r from-primary-600 to-primary-700 text-white">
        <div className="container text-center">
          <h2 className="text-3xl md:text-4xl font-serif font-bold mb-4">
            Ready to Consult with Dr. Swarali?
          </h2>
