    ...
    <div>
              ...
              <div className="aspect-square bg-gradient-to-br from-primary-100 to-accent-100 rounded-3xl overflow-hidden shadow-xl">
                <div className="w-full h-full flex items-center justify-center">
                  <div className="text-center p-12">
                    ...
                    <p className="text-gray-600 font-medium">Dr. Azhar</p>
                    <p className="text-primary-600 text-sm">Bariatric Surgery Specialist</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="bg-gray-50 rounded-xl p-6">
                    <h4 className="font-semibold text-gray-900 mb-2">M.D. from Charles University, Prague</h4>
                    <p className="text-gray-600">Advanced medical degree from prestigious European institution</p>
                  </div>
                  <div className="bg-gray-50 rounded-xl p-6">
                    <h4 className="font-semibold text-gray-900 mb-2">Board certification</h4>
                    <p className="text-gray-600">American Board of Cosmetic Surgery</p>
                  </div>
                </div>
              </div>
              <div>
                ...
                <div className="space-y-4">
                  <div className="bg-gray-50 rounded-xl p-6">
                    <h4 className="font-semibold text-gray-900 mb-2">Customized Facial Contouring & Jawline Sculpting</h4>
                    <p className="text-gray-600">Expert in advanced facial sculpting procedures and bariatric surgery techniques</p>
                  </div>
                  <div className="bg-gray-50 rounded-xl p-6">
        ...
        <div className="container">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                { day: "Monday", time: "-", available: false },
                { day: "Tuesday", time: "9:00-14:00", available: true },
                { day: "Wednesday", time: "-", available: false },
                { day: "Thursday", time: "9:00-14:00", available: true },
                { day: "Friday", time: "-", available: false },
                { day: "Saturday", time: "9:00-14:00", available: true }
              ].map((schedule, index) => (
      ...
      <section className="section-padding bg-gradient-to-r from-primary-600 to-primary-700 text-white">
        <div className="container text-center">
          <h2 className="text-3xl md:text-4xl font-serif font-bold mb-4">Ready to Consult with Dr. Azhar?</h2>
          <p className="text-xl text-primary-100 mb-8 max-w-2xl mx-auto">Schedule your consultation today and experience expert bariatric surgery care.</p>
...
export default DoctorProfileAzhar
