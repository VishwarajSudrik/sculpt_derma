    ...
    <div>
                ...
                <div className="w-full h-full flex items-center justify-center">
                  <div className="text-center p-12">
                    <div className="w-32 h-32 bg-primary-200 rounded-full mx-auto mb-6 flex items-center justify-center">
                      <span className="text-white text-4xl font-bold">NM</span>
                    </div>
                    <p className="text-gray-600 font-medium">Dr. Nitin Maske</p>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="bg-gray-50 rounded-xl p-6">
                    <h4 className="font-semibold text-gray-900 mb-2">M.D. from Stanford University School of Medicine</h4>
                    <p className="text-gray-600">Prestigious medical education from world-renowned institution</p>
                  </div>
                  <div className="bg-gray-50 rounded-xl p-6">
                    <h4 className="font-semibold text-gray-900 mb-2">Board certification</h4>
                    <p className="text-gray-600">American Board of Plastic Surgery</p>
                  </div>
                </div>
              </div>
              <div>
                ...
                <div className="space-y-4">
                  <div className="bg-gray-50 rounded-xl p-6">
                    <h4 className="font-semibold text-gray-900 mb-2">Non-Surgical Facelift & Skin Tightening</h4>
                    <p className="text-gray-600">Expert in advanced dermatological procedures and non-invasive skin rejuvenation treatments</p>
                  </div>
                  <div className="bg-gray-50 rounded-xl p-6">
                    <h4 className="font-semibold text-gray-900 mb-2">Years of Practice</h4>
                    <p className="text-gray-600">15 years of experience in dermatology</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="container">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                { day: "Monday", time: "9:00 - 12:00", available: true },
                { day: "Tuesday", time: "9:00 - 12:00", available: true },
                { day: "Wednesday", time: "-", available: false },
                { day: "Thursday", time: "9:00 - 12:00", available: true },
                { day: "Friday", time: "9:00 - 12:00", available: true },
      ...
      <section className="section-padding bg-gradient-to-r from-primary-600 to-primary-700 text-white">
        <div className="container text-center">
          <h2 className="text-3xl md:text-4xl font-serif font-bold mb-4">Ready to Consult with Dr. Nitin Maske?</h2>
...
export default DoctorProfileNitin
