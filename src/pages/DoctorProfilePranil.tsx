    ...
    <div>
              ...
              <div className="aspect-square bg-gradient-to-br from-primary-100 to-accent-100 rounded-3xl overflow-hidden shadow-xl">
                <div className="w-full h-full flex items-center justify-center">
                  <div className="text-center p-12">
                    ...
                    <p className="text-gray-600 font-medium">Dr. Pranil</p>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-gray-600 leading-relaxed">
                Dr. Pranil is a dedicated cosmetic dentistry specialist with a passion for creating beautiful, healthy smiles. With extensive experience in advanced dental procedures, he combines technical expertise with artistic vision to deliver exceptional results for his patients.
              </p>
              <p className="text-gray-600 leading-relaxed">
                His approach to cosmetic dentistry focuses on enhancing natural beauty while maintaining optimal oral health. Dr. Pranil stays updated with the latest techniques and technologies in dental aesthetics to provide cutting-edge treatments tailored to each patient's unique needs.
              </p>
            </div>
          </div>
        </div>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="bg-gray-50 rounded-xl p-6">
                    <h4 className="font-semibold text-gray-900 mb-2">BDS, MDS (Cosmetic Dentistry)</h4>
                    <p className="text-gray-600">Advanced dental education with specialization in cosmetic procedures</p>
                  </div>
                  <div className="bg-gray-50 rounded-xl p-6">
                    <h4 className="font-semibold text-gray-900 mb-2">Board certification</h4>
                    <p className="text-gray-600">Certified Cosmetic Dentist</p>
                  </div>
                </div>
              </div>
              <div>
                ...
                <div className="space-y-4">
                  <div className="bg-gray-50 rounded-xl p-6">
                    <h4 className="font-semibold text-gray-900 mb-2">Smile Design & Dental Aesthetics</h4>
                    <p className="text-gray-600">Expert in cosmetic dental procedures including veneers, crowns, teeth whitening, and smile makeovers</p>
                  </div>
                  <div className="bg-gray-50 rounded-xl p-6">
                    <h4 className="font-semibold text-gray-900 mb-2">Years of Practice</h4>
                    <p className="text-gray-600">12 years of experience in cosmetic dentistry</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="section-padding bg-gradient-to-r from-primary-600 to-primary-700 text-white">
        <div className="container text-center">
          <h2 className="text-3xl md:text-4xl font-serif font-bold mb-4">Ready to Transform Your Smile with Dr. Pranil?</h2>
          <p className="text-xl text-primary-100 mb-8 max-w-2xl mx-auto">Schedule your consultation today and discover the art of cosmetic dentistry.</p>
...
export default DoctorProfilePranil
